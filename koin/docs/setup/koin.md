...
从 3.5.0 开始，你可以使用 BOM 版本来管理所有 Koin 库的版本。在你的应用中使用 BOM 时，你无需向 Koin 库依赖项本身添加任何版本。当你更新 BOM 版本时，你使用的所有库都会自动更新到它们的新版本。
...
将 `koin-core` 依赖项添加到你的 multiplatform 应用程序，用于共享 Kotlin 部分:
...
### **Koin BOM**
Koin Bill of Materials (BOM) 允许你仅通过指定 BOM 的版本来管理所有 Koin 库的版本。BOM 本身具有指向不同 Koin 库的稳定版本的链接，从而使它们可以很好地协同工作。在你的应用程序中使用 BOM 时，你无需向 Koin 库依赖项本身添加任何版本。当你更新 BOM 版本时，你使用的所有库都会自动更新到它们的新版本。
