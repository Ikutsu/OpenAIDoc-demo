...
2. Clone the [project template](https://github.com/kotlin-hands-on/web-app-react-kotlin-js-gradle) and open it in IntelliJ
   ...
   * An HTML template page in `src/jsMain/resources/index.html` for inserting JavaScript code that you'll be using in
   ...
   <body>
       <div id="root"></div>
       <script src="/img/confexplorer.js"></script>
   </body>
   </html>
   ```
   {validate="false"}
...
<img src="/img/browser-development-run.png" width="700" alt="Gradle tasks list" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/red-page.png" width="700" alt="Blank red page" style={{verticalAlign: 'middle'}}/>
...
1. Edit the run configuration that IntelliJ IDEA automatically generates after running the Gradle `run` task for the first time:
   ...
   <img src="/img/edit-configurations-continuous.png" width="700" alt="Edit a run configuration" style={{verticalAlign: 'middle'}}/>

2. In the **Run/Debug Configurations** dialog, add the `--continuous` option to the arguments for the run configuration:

   <img src="/img/continuous-mode.png" width="700" alt="Enable continuous mode" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/hello-react-js.png" width="700" alt="An HTML page example" style={{verticalAlign: 'middle'}}/>
...
<div>
    ...
    <img src="/img/https://via.placeholder.com/640x360.png?text=Video+Player+Placeholder" style={{verticalAlign: 'middle'}}/>
</div>
```
...
<img src="/img/website-draft.png" width="700" alt="The web app draft" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/current-layout.png" width="700" alt="Current layout" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/structured-layout.png" width="700" alt="Structured layout with components" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/alert-window.png" width="700" alt="Browser alert window" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/two-videos-select.png" width="700" alt="Two videos are selected in both lists simultaneously" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/social-buttons.png" width="700" alt="Share window" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/website-api-data.png" width="700" alt="Fetched data from API" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/deployment-to-production.png" width="700" alt="Web app deployment to production" style={{verticalAlign: 'middle'}}/>
