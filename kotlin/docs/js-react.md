...
<img src="/img/browser-development-run.png" width="700" alt="Gradle tasks list"  'middle'}}/>
...
<img src="/img/red-page.png" width="700" alt="Blank red page"  'middle'}}/>
...
1. Edit the run configuration that IntelliJ IDEA automatically generates after running the Gradle `run` task for the first time:
   ...
   <img src="/img/edit-configurations-continuous.png" width="700" alt="Edit a run configuration"  'middle'}}/>

2. In the **Run/Debug Configurations** dialog, add the `--continuous` option to the arguments for the run configuration:

   <img src="/img/continuous-mode.png" width="700" alt="Enable continuous mode"  'middle'}}/>
...
<img src="/img/hello-react-js.png" width="700" alt="An HTML page example"  'middle'}}/>
...
<img src="/img/website-draft.png" width="700" alt="The web app draft"  'middle'}}/>
...
<img src="/img/current-layout.png" width="700" alt="Current layout"  'middle'}}/>
...
<img src="/img/structured-layout.png" width="700" alt="Structured layout with components"  'middle'}}/>
...
<img src="/img/alert-window.png" width="700" alt="Browser alert window"  'middle'}}/>
...
<img src="/img/two-videos-select.png" width="700" alt="Two videos are selected in both lists simultaneously"  'middle'}}/>
...
<img src="/img/social-buttons.png" width="700" alt="Share window"  'middle'}}/>
...
<img src="/img/website-api-data.png" width="700" alt="Fetched data from API"  'middle'}}/>
...
<img src="/img/deployment-to-production.png" width="700" alt="Web app deployment to production"  'middle'}}/>
