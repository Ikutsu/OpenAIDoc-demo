...
<img src="/img/browser-development-run.png" width="700" alt="Gradle tasks l  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/red-page.png" width="700" alt="Blank red p  style={{verticalAlign: 'middle'}}/>
...
1. Edit the run configuration that IntelliJ IDEA automatically generates after running the Gradle `run` task for the first time:
   ...
   <img src="/img/edit-configurations-continuous.png" width="700" alt="Edit a run configurat  style={{verticalAlign: 'middle'}}/>

2. In the **Run/Debug Configurations** dialog, add the `--continuous` option to the arguments for the run configuration:

   <img src="/img/continuous-mode.png" width="700" alt="Enable continuous m  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/hello-react-js.png" width="700" alt="An HTML page exam  style={{verticalAlign: 'middle'}}/>
...
<div>
    ...
    <img src="https://via.placeholder.com/640x360.png?text=Video+Player+Placeholder"  'middle'}}/>
</div>
```
...
<img src="/img/website-draft.png" width="700" alt="The web app dr  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/current-layout.png" width="700" alt="Current lay  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/structured-layout.png" width="700" alt="Structured layout with componen  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/alert-window.png" width="700" alt="Browser alert win  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/two-videos-select.png" width="700" alt="Two videos are selected in both lists simultaneous  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/social-buttons.png" width="700" alt="Share win  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/website-api-data.png" width="700" alt="Fetched data from   style={{verticalAlign: 'middle'}}/>
...
<img src="/img/deployment-to-production.png" width="700" alt="Web app deployment to product  style={{verticalAlign: 'middle'}}/>
