...
<img src="/img/direct-integration-scheme.svg" width="700" alt="Direct integration diagram"  'middle'}}/>
...
3. On the **Build Phases** tab of the project settings, click **+** and select **New Run Script Phase**.
   ...
   <img src="/img/xcode-run-script-phase-1.png" width="700" alt="Add run script phase"  'middle'}}/>
...
4. Adjust the following script and copy the result to the run script phase:
   ...
   * In the `./gradlew` command, specify the name of the shared module, for example, `:shared` or `:composeApp`.
   ...
   <img src="/img/xcode-run-script-phase-2.png" width="700" alt="Add the script"  'middle'}}/>

5. Drag the **Run Script** phase before the **Compile Sources** phase.

   <img src="/img/xcode-run-script-phase-3.png" width="700" alt="Drag the Run Script phase"  'middle'}}/>

6. On the **Build Settings** tab, disable the **User Script Sandboxing** option under **Build Options**:

   <img src="/img/disable-sandboxing-in-xcode-project-settings.png" width="700" alt="User Script Sandboxing"  'middle'}}/>
