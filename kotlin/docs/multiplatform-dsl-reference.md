...
The plugin versions match the Kotlin release versions. The most recent version is 2.1.20.
...
<table>
   ...
   <code>wasmWasi</code>
        ...
        <td>
   Use it if you need support for the <a href="https://github.com/WebAssembly/WASI">WASI</a> system interface.
   </td>
    </tr>
    <tr>
        <td>
   ...
   Select the execution environment:
            ...
            <p>
   Learn more in <a href="js-project-setup.md#execution-environments">Setting up a Kotlin/JS project</a>.
   </p>
   </td>
    </tr>
    <tr>
   ...
   Kotlin/Native
        ...
        <td>
   <p>
   Learn about currently supported targets for the macOS, Linux, and Windows hosts in <a href="native-target-support.md">Kotlin/Native target support</a>.
   </p>
   </td>
    </tr>
    <tr>
   ...
   Android applications and libraries
        ...
        <td>
   <code>androidTarget</code>
   </td>
        <td>
   <p>
   Manually apply an Android Gradle plugin: <code>com.android.application</code> or <code>com.android.library</code>.
   </p>
            <p>
