...
5. Choose **CocoaPods Dependency Manager** as the iOS framework distribution option.
   ...
   <img src="/img/as-project-wizard.png" width="700" alt="Android Studio wizard with the Kotlin Multiplatform plu  style={{verticalAlign: 'middle'}}/>
...
1. Disable sandboxing of user scripts in the application target:
   ...
   <img src="/img/disable-sandboxing-cocoapods.png" width="700" alt="Disable sandboxing CocoaP  style={{verticalAlign: 'middle'}}/>
