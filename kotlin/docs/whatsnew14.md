...
<img src="/img/multiplatform-project-1-wn.png" alt="Kotlin Project Wizard – Multiplatform proj  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/multiplatform-project-2-wn.png" alt="Kotlin Project Wizard - Configure targe  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/coroutine-debugger-wn.png" alt="Debugging corouti  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/coroutines-dump-wn.png" alt="Coroutines D  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/iosmain-hierarchy.png" width="300" alt="Code shared for iOS targe  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/manual-hierarchical-structure.svg" alt="Hierarchical struct  style={{verticalAlign: 'middle'}}/>
...
configuration in 1.4.0. Now the IDE loads the changes only when you explicitly apply them.
  ...
  <img src="/img/gradle-kts-load-config.png" alt="*.gradle.kts – Load Configurat  style={{verticalAlign: 'middle'}}/>
...
to the script configurations without updating the whole project. This takes much less time than reimporting the whole project.
  ...
  <img src="/img/gradle-kts.png" alt="*.gradle.kts – Load Script Changes and Load Gradle Chan  style={{verticalAlign: 'middle'}}/>
  ...
  <img src="/img/gradle-kts-standalone.png" alt="*.gradle.kts – Add to standalone scrip  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/run-migration-wn.png" width="300" alt="Run migrat  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/migration-inspection-wn.png" alt="Migration inspecti  style={{verticalAlign: 'middle'}}/>
