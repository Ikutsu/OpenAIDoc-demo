...
<img src="/img/iosmain-hierarchy.png" alt="Code shared for iOS targets" width="300" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/manual-hierarchical-structure.svg" alt="Hierarchical structure" style={{verticalAlign: 'middle'}}/>
...
configuration in 1.4.0. Now the IDE loads the changes only when you explicitly apply them.
  ...
  <img src="/img/gradle-kts-load-config.png" alt="*.gradle.kts – Load Configuration" style={{verticalAlign: 'middle'}}/>
...
to the script configurations without updating the whole project. This takes much less time than reimporting the whole project.
  ...
  <img src="/img/gradle-kts.png" alt="*.gradle.kts – Load Script Changes and Load Gradle Changes" style={{verticalAlign: 'middle'}}/>
  ...
  <img src="/img/gradle-kts-standalone.png" alt="*.gradle.kts – Add to standalone scripts" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/run-migration-wn.png" alt="Run migration" width="300" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/migration-inspection-wn.png" alt="Migration inspections" style={{verticalAlign: 'middle'}}/>
