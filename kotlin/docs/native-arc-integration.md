...
<img src="/img/native-retain-cycle.png" alt="Retain cycles"  'middle'}}/>{height=200}
...
<img src="/img/native-objc-kotlin-retain-cycles.png" alt="Retain cycles with Objective-C and Kotlin objects"  'middle'}}/>{height=150}
