...
<img src="/img/native-retain-cycle.png" alt="Retain cyc  style={{verticalAlign: 'middle'}}/>{height=200}
...
<img src="/img/native-objc-kotlin-retain-cycles.png" alt="Retain cycles with Objective-C and Kotlin objec  style={{verticalAlign: 'middle'}}/>{height=150}
