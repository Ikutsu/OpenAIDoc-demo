...
:::info
   ...
   <img src="icon-1-done.svg" width="20" alt="First step"   'middle'}}/> <a href="kotlin-tour-hello-world.md">Hello world</a><br />
        ...
        <img src="icon-3.svg" width="20" alt="Third step"   'middle'}}/> <strong>Collections</strong><br />
...
<ul>
  <li>
    <h3>Hint</h3>
    <div>Make sure that you check the requested protocol in upper case. You can use the <a href="https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.text/uppercase.html"><code>.uppercase()</code></a>
function to help you with this.</div>
  </li>
</ul>
