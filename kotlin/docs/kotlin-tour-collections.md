...
:::info
   ...
   <img src="/img/icon-1-done.svg" width="20" alt="First step"  style={{verticalAlign: 'middle'}}/> <a href="kotlin-tour-hello-world.md">Hello world</a><br />
        ...
        <img src="/img/icon-3.svg" width="20" alt="Third step"  style={{verticalAlign: 'middle'}}/> <strong>Collections</strong><br />
        <img src="/img/icon-4-todo.svg" width="20" alt="Fourth step"  style={{verticalAlign: 'middle'}}/> <a href="kotlin-tour-control-flow.md">Control flow</a><br />
        <img src="/img/icon-5-todo.svg" width="20" alt="Fifth step"  style={{verticalAlign: 'middle'}}/> <a href="kotlin-tour-functions.md">Functions</a><br />
