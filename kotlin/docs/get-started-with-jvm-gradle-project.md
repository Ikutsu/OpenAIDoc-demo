...
:::
   ...
   <img src="/img/jvm-new-gradle-project.png" width="700" alt="Create a console application"  'middle'}}/>
...
* **Local installation:**
   ...
   <img src="/img/jvm-new-gradle-project-advanced.png" width="700" alt="Advanced settings"  'middle'}}/>
...
1. Open the Gradle window by selecting **View** | **Tool Windows** | **Gradle**:
   ...
   <img src="/img/jvm-gradle-view-build.png" width="700" alt="Main.kt with main fun"  'middle'}}/>
...
4. Run the application by clicking the green **Run** icon in the gutter and select **Run 'MainKt'**.
   ...
   <img src="/img/jvm-run-app-gradle.png" width="350" alt="Running a console app"  'middle'}}/>

You can see the result in the **Run** tool window:

<img src="/img/jvm-output-gradle.png" width="600" alt="Kotlin run output"  'middle'}}/>
