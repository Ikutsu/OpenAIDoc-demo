...
2. In **composeApp** | **Tasks** | **kotlin browser**, select and run the **wasmJsBrowserDevelopmentRun** task.
   ...
   <img src="/img/wasm-gradle-task-window.png" width="600" alt="Run the Gradle task"  'middle'}}/>
...
:::
   ...
   <img src="/img/wasm-composeapp-browser-clickme.png" width="650" alt="Click me"  'middle'}}/>

   Now you see the Compose Multiplatform logo:

   <img src="/img/wasm-composeapp-browser.png" width="650" alt="Compose app in browser"  'middle'}}/>

## Generate artifacts

In **composeApp** | **Tasks** | **kotlin browser**, select and run the **wasmJsBrowserDistribution** task.

<img src="/img/wasm-gradle-task-window-compose.png" width="600" alt="Run the Gradle task"  'middle'}}/>
...
<img src="/img/wasm-composeapp-directory.png" width="600" alt="Artifacts directory"  'middle'}}/>
...
3. In a browser, navigate to your GitHub pages domain.
   ...
   <img src="/img/wasm-composeapp-github-clickme.png" width="650" alt="Navigate to GitHub pages"  'middle'}}/>
...
<a href="https://slack-chats.kotlinlang.org/c/webassembly"><img src="join-slack-channel.svg" width="500" alt="Join the Kotlin/Wasm community"  "block"}}/></a>
