...
<img src="/img/script-deps-create-root-project.png" width="700" alt="Create a root project for custom Kotlin script  style={{verticalAlign: 'middle'}}/>
...
7. Click **Create**.
   ...
   <img src="/img/script-deps-module-definition.png" width="700" alt="Create script definition mod  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/script-deps-project-structure.png" width="300" alt="Custom scripting project struct  style={{verticalAlign: 'middle'}}/>
...
2. Create a run configuration that starts the scripting host and executes this file:
   ...
   3. In the **Create Run Configuration** dialog, add the script file name to **Program arguments** and click **OK**.
      ...
      <img src="/img/script-deps-run-config.png" width="800" alt="Scripting host run configurat  style={{verticalAlign: 'middle'}}/>
