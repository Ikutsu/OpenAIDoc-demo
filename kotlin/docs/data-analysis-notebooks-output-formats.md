...
<img src="/img/gaussian-distribution-output.png" width="700" alt="Different outputs for Gaussian distribution" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/plain-text-output.png" width="300" alt="Plain text code output" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/markdown-cells-output.png" width="700" alt="Rich text in Markdown cells" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/direct-html-output.png" width="300" alt="Using HTML script" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/bufferedimage-output.png" width="400" alt="Using default BufferedImage to display images" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/external-images-output.png" width="400" alt="Using external image links" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/embedded-images-output.png" width="400" alt="Using embedded images" style={{verticalAlign: 'middle'}}/>
...
2. In the new cell, run your formula:
   ...
   <img src="/img/latex-output.png" width="300" alt="Using LaTeX to render mathematical formulas" style={{verticalAlign: 'middle'}}/>
...
3. Explore the data in your frame, for example, by finding the product and month with the highest sales:
   ...
   <img src="/img/dataframe-output.png" width="500" alt="Using DataFrame to visualize data" style={{verticalAlign: 'middle'}}/>
...
2. Use the same data frame and run the `plot()` function in the new cell:
   ...
   <img src="/img/kandy-output.png" width="700" alt="Using Kandy to render visualize data" style={{verticalAlign: 'middle'}}/>
