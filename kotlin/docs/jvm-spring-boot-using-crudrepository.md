...
<p>
   The `findByIdOrNull()` function is an <a href="extensions.md#extension-functions">extension function</a> for `CrudRepository` interface in Spring Data JDBC.
</p>
