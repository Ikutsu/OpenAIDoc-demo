...
<video src="/img/https://www.youtube.com/v/R1JpkpPzyBU" title="What's new in Kotlin 1.8.20"/>
...
<img src="/img/default-hierarchy-example.svg" alt="An example of using the default target hierarchy" style={{verticalAlign: 'middle'}}/>{thumbnail="true" width="350" thumbnail-same-file="true"}
...
<img src="/img/xcode-gradle-output.png" width="700" alt="Improved output for Gradle errors in Xcode" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/comparison-of-full-and-precise-backups.png" width="700" alt="Comparison of full and precise backups" style={{verticalAlign: 'middle'}}/>
