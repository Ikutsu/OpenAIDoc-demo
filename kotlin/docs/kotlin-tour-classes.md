...
:::info
   ...
   <img src="icon-1-done.svg" width="20" alt="First step"   'middle'}}/> <a href="kotlin-tour-hello-world.md">Hello world</a><br />
        ...
        <img src="icon-4-done.svg" width="20" alt="Fourth step"   'middle'}}/> <a href="kotlin-tour-control-flow.md">Control flow</a><br />
        <img src="icon-5-done.svg" width="20" alt="Fifth step"   'middle'}}/> <a href="kotlin-tour-functions.md">Functions</a><br />
        <img src="icon-6.svg" width="20" alt="Sixth step"   'middle'}}/> <strong>Classes</strong><br />
...
<ul>
  <li>
    <h3>Hint 1</h3>
    <div>Lists have an extension function called <a href="https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/random.html"><code>.random()</code></a>
        that returns a random item within a list.</div>
  </li>
</ul>
...
<ul>
  <li>
    <h3>Hint 2</h3>
    <div><code>Random.nextInt(from = ..., until = ...)</code> gives you a random <code>Int</code> number within specified limits.</div>
  </li>
</ul>
