...
<img src="/img/run-gradle-task.png" width="700" alt="Gradle Run task in IntelliJ I  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/cli-output.png" width="700" alt="Executing the JS target in a Kotlin Multiplatform project in IntelliJ I  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/browser-console-output.png" width="700" alt="Console output in browser developer to  style={{verticalAlign: 'middle'}}/>
