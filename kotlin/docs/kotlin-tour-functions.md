...
:::info
   ...
   <img src="/img/icon-1-done.svg" width="20" alt="First step"  style={{verticalAlign: 'middle'}}/> <a href="kotlin-tour-hello-world.md">Hello world</a><br />
        ...
        <img src="/img/icon-5.svg" width="20" alt="Fifth step"  style={{verticalAlign: 'middle'}}/> <strong>Functions</strong><br />
        <img src="/img/icon-6-todo.svg" width="20" alt="Sixth step"  style={{verticalAlign: 'middle'}}/> <a href="kotlin-tour-classes.md">Classes</a><br />
