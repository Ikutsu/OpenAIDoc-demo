...
:::info
   ...
   <img src="icon-1-done.svg" width="20" alt="First step"  'middle'}}/> <a href="mapping-primitive-data-types-from-c.md">Mapping primitive data types from C</a><br/>
       <img src="icon-2.svg" width="20" alt="Second step"  'middle'}}/> <strong>Mapping struct and union types from C</strong><br/>
       <img src="icon-3-todo.svg" width="20" alt="Third step"  'middle'}}/> <a href="mapping-function-pointers-from-c.md">Mapping function pointers</a><br/>
