...
:::info
    ...
    <p>
   This is the first part of the <strong>Mapping Kotlin and C</strong> tutorial series.
   </p>
    <p>
   <img src="/img/icon-1.svg" width="20" alt="First step" style={{verticalAlign: 'middle'}}/> <strong>Mapping primitive data types from C</strong><br/>
       <img src="/img/icon-2-todo.svg" width="20" alt="Second step" style={{verticalAlign: 'middle'}}/> <a href="mapping-struct-union-types-from-c.md">Mapping struct and union types from C</a><br/>
