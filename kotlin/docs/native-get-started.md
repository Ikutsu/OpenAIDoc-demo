...
4. Follow the suggestion to reload Gradle files:
   ...
   <img src="/img/load-gradle-changes.png" width="295" alt="Load Gradle changes but  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/native-run-gutter.png" width="478" alt="Run the applicat  style={{verticalAlign: 'middle'}}/>

IntelliJ IDEA runs the code using the Gradle task and outputs the result in the **Run** tab:

<img src="/img/native-output-gutter-1.png" width="331" alt="Application out  style={{verticalAlign: 'middle'}}/>

After the first run, the IDE creates the corresponding run configuration at the top:

<img src="/img/native-run-config.png" width="503" alt="Gradle run configurat  style={{verticalAlign: 'middle'}}/>
...
5. Enter your name and enjoy the result:
   ...
   <img src="/img/native-output-gutter-2.png" width="422" alt="Application out  style={{verticalAlign: 'middle'}}/>
...
4. Enter your name and see the result:
   ...
   <img src="/img/native-output-gutter-3.png" width="422" alt="Application out  style={{verticalAlign: 'middle'}}/>
