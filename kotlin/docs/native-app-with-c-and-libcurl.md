...
3. Explore the project structure:
   ...
   <img src="/img/native-project-structure.png" width="700" alt="Native application project structure"  'middle'}}/>
...
2. If there are no errors during compilation, click the green **Run** icon in the gutter next to the `main()` function or
   ...
   <img src="/img/native-output.png" width="700" alt="Application output with HTML-code"  'middle'}}/>
