...
:::info
   ...
   <img src="icon-1-done.svg" width="20" alt="First step" style={{verticalAlign: 'middle'}}/> <a href="mapping-primitive-data-types-from-c.md">Mapping primitive data types from C</a><br/>
        ...
        <img src="icon-3.svg" width="20" alt="Third step" style={{verticalAlign: 'middle'}}/> <strong>Mapping function pointers</strong><br/>
        <img src="icon-4-todo.svg" width="20" alt="Fourth step" style={{verticalAlign: 'middle'}}/> <a href="mapping-strings-from-c.md">Mapping strings from C</a><br/>
   </p>
