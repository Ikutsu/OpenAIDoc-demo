...
:::info
   ...
   This is the first part of the <strong>Get started with Spring Boot and Kotlin</strong> tutorial:
    ...
    <p>
   <img src="icon-1.svg" width="20" alt="First step"  'middle'}}/> <strong>Create a Spring Boot project with Kotlin</strong><br/><img src="icon-2-todo.svg" width="20" alt="Second step"  'middle'}}/> Add a data class to the Spring Boot project<br/><img src="icon-3-todo.svg" width="20" alt="Third step"  'middle'}}/> Add database support for the Spring Boot project<br/><img src="icon-4-todo.svg" width="20" alt="Fourth step"  'middle'}}/> Use Spring Data CrudRepository for database access<br/>
   </p>
...
:::
   ...
   * **Java**: 17
   ...
   <img src="/img/create-spring-boot-project.png" width="800" alt="Create Spring Boot proj  style={{verticalAlign: 'middle'}}/>
...
5. Select the following dependencies that will be required for the tutorial:
   ...
   * **SQL | H2 Database**
   ...
   <img src="/img/set-up-spring-boot-project.png" width="800" alt="Set up Spring Boot proj  style={{verticalAlign: 'middle'}}/>
...
7. After this, you can observe the following structure in the **Project view**:
   ...
   <img src="/img/spring-boot-project-view.png" width="400" alt="Set up Spring Boot proj  style={{verticalAlign: 'middle'}}/>
...
1. Click the green Run icon in the gutter beside the `main()` method:
    ...
    <img src="/img/run-spring-boot-application.png" width="706" alt="Run Spring Boot applicat  style={{verticalAlign: 'middle'}}/>
...
2. Once the application starts, open the following URL:
    ...
    <img src="/img/spring-application-response.png" width="706" alt="Spring Application respo  style={{verticalAlign: 'middle'}}/>
