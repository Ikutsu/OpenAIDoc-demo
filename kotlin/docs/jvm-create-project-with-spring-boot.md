...
:::
   ...
   * **Java**: 17
   ...
   <img src="/img/create-spring-boot-project.png" width="800" alt="Create Spring Boot project"  'middle'}}/>
...
5. Select the following dependencies that will be required for the tutorial:
   ...
   * **SQL | H2 Database**
   ...
   <img src="/img/set-up-spring-boot-project.png" width="800" alt="Set up Spring Boot project"  'middle'}}/>
...
7. After this, you can observe the following structure in the **Project view**:
   ...
   <img src="/img/spring-boot-project-view.png" width="400" alt="Set up Spring Boot project"  'middle'}}/>
...
1. Click the green Run icon in the gutter beside the `main()` method:
    ...
    <img src="/img/run-spring-boot-application.png" width="706" alt="Run Spring Boot application"  'middle'}}/>
...
2. Once the application starts, open the following URL:
    ...
    <img src="/img/spring-application-response.png" width="706" alt="Spring Application response"  'middle'}}/>
