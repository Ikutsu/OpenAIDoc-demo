...
:::info
   ...
   This is the first part of the <strong>Get started with Spring Boot and Kotlin</strong> tutorial:
    ...
    <p>
   <img src="icon-1.svg" width="20" alt="First step" style={{verticalAlign: 'middle'}}/> <strong>Create a Spring Boot project with Kotlin</strong><br/><img src="icon-2-todo.svg" width="20" alt="Second step" style={{verticalAlign: 'middle'}}/> Add a data class to the Spring Boot project<br/><img src="icon-3-todo.svg" width="20" alt="Third step" style={{verticalAlign: 'middle'}}/> Add database support for the Spring Boot project<br/><img src="icon-4-todo.svg" width="20" alt="Fourth step" style={{verticalAlign: 'middle'}}/> Use Spring Data CrudRepository for database access<br/>
   </p>
