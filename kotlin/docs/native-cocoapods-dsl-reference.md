...
The plugin versions match the [Kotlin release versions](releases.md). The latest stable version is 2.1.20.
...
| `extraOpts`                  | Specifies the list of options for a Pod library. For example, specific flags: ```Kotlin
