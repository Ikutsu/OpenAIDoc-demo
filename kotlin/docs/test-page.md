...
:::info
   ...
   <p>
   <img src="icon-1-done.svg" width="20" alt="First step"  'middle'}}/> <a href="jvm-create-project-with-spring-boot.md">Create a Spring Boot project with Kotlin</a><br/>
      <img src="icon-2-done.svg" width="20" alt="Second step"  'middle'}}/> <a href="jvm-spring-boot-add-data-class.md">Add a data class to the Spring Boot project</a><br/>
      <img src="icon-3.svg" width="20" alt="Third step"  'middle'}}/> <strong>Add database support for Spring Boot project</strong><br/>
      <img src="icon-4-todo.svg" width="20" alt="Fourth step"  'middle'}}/> Use Spring Data CrudRepository for database access><br/>
   </p>
...
<img src="/img/create-test.png" alt="Create a t  style={{verticalAlign: 'middle'}}/>{width="700"}

Regular (XML):

<img src="multiplatform-web-wizard.png" alt="Multiplatform web wizard" width="400"  'middle'}}/>

Inline:

<img src="/img/youtrack-logo.png" width="30" alt="YouTr  style={{verticalAlign: 'middle'}}/>

Zoomable:

<img src="/img/ksp-class-diagram.svg" alt="class diag  style={{verticalAlign: 'middle'}}/>{thumbnail="true" width="700" thumbnail-same-file="true"}

Button-style:

<a href="https://kmp.jetbrains.com">
   <img src="multiplatform-create-project-button.png" alt="Create a proj  style={{verticalAlign: 'middle'}}/>
</a>
