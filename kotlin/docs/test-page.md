...
:::info
   ...
   <p>
   <img src="/img/icon-1-done.svg" width="20" alt="First step" style={{verticalAlign: 'middle'}}/> <a href="jvm-create-project-with-spring-boot.md">Create a Spring Boot project with Kotlin</a><br/>
      <img src="/img/icon-2-done.svg" width="20" alt="Second step" style={{verticalAlign: 'middle'}}/> <a href="jvm-spring-boot-add-data-class.md">Add a data class to the Spring Boot project</a><br/>
      <img src="/img/icon-3.svg" width="20" alt="Third step" style={{verticalAlign: 'middle'}}/> <strong>Add database support for Spring Boot project</strong><br/>
      <img src="/img/icon-4-todo.svg" width="20" alt="Fourth step" style={{verticalAlign: 'middle'}}/> Use Spring Data CrudRepository for database access><br/>
   </p>
...
<table>
   ...
   Now
    ...
    <tr>
        <td rowspan="2">Dependencies of the <code>jvmMain</code> compilation
   </td>
<td>
   ```kotlin
jvm<Scope>
...
```
    ...
    <tr>
        <td>
   Dependencies of the <code>jvmMain</code> source set
   </td>
<td colspan="2">
...
```
    ...
    <tr>
        <td>
   Dependencies of the <code>jvmTest</code> compilation
   </td>
<td>
   ```kotlin
jvmTest<Scope>
...
```
    ...
    <tr>
        <td>
   Dependencies of the <code>jvmTest</code> source set
   </td>
<td colspan="2">
...
<video src="/img/https://www.youtube.com/v/Ol_96CHKqg8" title="What's new in Kotlin 1.9.20"/>

### Pictures

Regular (Markdown):

<img src="/img/create-test.png" alt="Create a test" style={{verticalAlign: 'middle'}}/>{width="700"}

Regular (XML):

<img src="/img/multiplatform-web-wizard.png" alt="Multiplatform web wizard" width="400" style={{verticalAlign: 'middle'}}/>

Inline:

<img src="/img/youtrack-logo.png" width="30" alt="YouTrack" style={{verticalAlign: 'middle'}}/>

Zoomable:

<img src="/img/ksp-class-diagram.svg" alt="class diagram" style={{verticalAlign: 'middle'}}/>{thumbnail="true" width="700" thumbnail-same-file="true"}

Button-style:

<a href="https://kmp.jetbrains.com">
   <img src="/img/multiplatform-create-project-button.png" alt="Create a project" style="block"/>
</a>
