...
JetBrains 遵循 [Kotlin 语言演进原则](kotlin-evolution-principles.md)，以务实的设计为指导，不断发展 Kotlin 语言。

:::note
语言特性提案从 Kotlin 1.7.0 开始列出。

有关语言特性状态的说明，请参阅 [Kotlin 演进原则文档](kotlin-evolution-principles.md#pre-stable-features)。
