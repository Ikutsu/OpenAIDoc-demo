...
1. In Xcode, go to **Product** | **Scheme** | **Edit scheme** or click the scheme icon in the top bar and select **Edit scheme**:
   ...
   <img src="/img/xcode-edit-schemes.png" width="700" alt="Edit sch  style={{verticalAlign: 'middle'}}/>

2. Select the **Build** | **Pre-actions** item, then click **+** | **New Run Script Action**:

   <img src="/img/xcode-new-run-script-action.png" width="700" alt="New run script act  style={{verticalAlign: 'middle'}}/>
...
4. Choose your app's target in the **Provide build settings from** section:
   ...
   <img src="/img/xcode-filled-run-script-action.png" width="700" alt="Filled run script act  style={{verticalAlign: 'middle'}}/>
...
5. You can now import the shared module into your local Swift package and use Kotlin code.
   ...
   <img src="/img/xcode-spm-usage.png" width="700" alt="SPM us  style={{verticalAlign: 'middle'}}/>
