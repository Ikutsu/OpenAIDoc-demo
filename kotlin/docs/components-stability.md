...
* **Stability** status. This shows how quickly each project is evolving and how much risk the users are taking when adopting it.
  The stability status completely coincides with the [stability level of the Kotlin language features and its components](#stability-levels-explained):
    * <img src="https://kotl.in/badges/experimental.svg" alt="Experimental stability le  style={{verticalAlign: 'middle'}}/> stands for **Experimental**
    * <img src="https://kotl.in/badges/alpha.svg" alt="Alpha stability le  style={{verticalAlign: 'middle'}}/> stands for **Alpha**
    * <img src="https://kotl.in/badges/beta.svg" alt="Beta stability le  style={{verticalAlign: 'middle'}}/> stands for **Beta**
    * <img src="https://kotl.in/badges/stable.svg" alt="Stable stability le  style={{verticalAlign: 'middle'}}/> stands for **Stable**
