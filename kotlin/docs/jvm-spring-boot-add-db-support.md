...
:::info
   ...
   This is the third part of the <strong>Getting started with Spring Boot and Kotlin</strong> tutorial. Before proceeding, make sure you've completed previous steps:
    ...
    <p>
   <img src="/img/icon-1-done.svg" width="20" alt="First step" style={{verticalAlign: 'middle'}}/> <a href="jvm-create-project-with-spring-boot.md">Create a Spring Boot project with Kotlin</a><br/><img src="/img/icon-2-done.svg" width="20" alt="Second step" style={{verticalAlign: 'middle'}}/> <a href="jvm-spring-boot-add-data-class.md">Add a data class to the Spring Boot project</a><br/><img src="/img/icon-3.svg" width="20" alt="Third step" style={{verticalAlign: 'middle'}}/> <strong>Add database support for Spring Boot project</strong><br/><img src="/img/icon-4-todo.svg" width="20" alt="Fourth step" style={{verticalAlign: 'middle'}}/> Use Spring Data CrudRepository for database access
   </p>
...
1. Create `schema.sql` file in the `src/main/resources` directory. It will store the database object definitions:
   ...
   <img src="/img/create-database-schema.png" width="400" alt="Create database schema" style={{verticalAlign: 'middle'}}/>
...
5. Execute the GET request and see the result in the **Run** tool window:
    ...
    <img src="/img/retrieve-message-by-its-id.png" width="706" alt="Retrieve message by its id" style={{verticalAlign: 'middle'}}/>
