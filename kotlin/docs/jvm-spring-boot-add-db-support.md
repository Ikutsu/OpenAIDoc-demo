...
1. Create `schema.sql` file in the `src/main/resources` directory. It will store the database object definitions:
   ...
   <img src="/img/create-database-schema.png" width="400" alt="Create database sch  style={{verticalAlign: 'middle'}}/>
...
3. Execute all POST requests. Use the green **Run** icon in the gutter next to the request declaration.
   ...
   <img src="/img/execute-post-requests.png" alt="Execute POST requ  style={{verticalAlign: 'middle'}}/>

4. Execute the GET request and see the result in the **Run** tool window:

   <img src="/img/execute-get-requests.png" alt="Execute GET reques  style={{verticalAlign: 'middle'}}/>
...
5. Execute the GET request and see the result in the **Run** tool window:
    ...
    <img src="/img/retrieve-message-by-its-id.png" width="706" alt="Retrieve message by its  style={{verticalAlign: 'middle'}}/>
