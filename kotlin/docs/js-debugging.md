...
<img src="/img/devtools-console.png" alt="Chrome DevTools cons  style={{verticalAlign: 'middle'}}/>{width="600"}
...
<img src="/img/devtools-sources.png" alt="Debugging in Chrome DevTo  style={{verticalAlign: 'middle'}}/>{width="600"}
...
<img src="/img/debug-config.png" width="700" alt="JavaScript debug configurat  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/debug-config-run.png" width="700" alt="JavaScript debug configurat  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/ide-console-output.png" width="700" alt="JavaScript debug output in the   style={{verticalAlign: 'middle'}}/>
