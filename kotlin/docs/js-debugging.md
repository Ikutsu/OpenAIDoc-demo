...
<img src="/img/devtools-console.png" alt="Chrome DevTools console" style={{verticalAlign: 'middle'}}/>{width="600"}
...
<img src="/img/devtools-sources.png" alt="Debugging in Chrome DevTools" style={{verticalAlign: 'middle'}}/>{width="600"}
...
<img src="/img/debug-config.png" width="700" alt="JavaScript debug configuration" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/debug-config-run.png" width="700" alt="JavaScript debug configuration" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/ide-console-output.png" width="700" alt="JavaScript debug output in the IDE" style={{verticalAlign: 'middle'}}/>
