...
<img src="/img/wasm-old-debugger.png" alt="Kotlin/Wasm old debugger" width="700" style={{verticalAlign: 'middle'}}/>
...
<img src="/img/wasm-debugger-improved.png" alt="Kotlin/Wasm improved debugger" width="700" style={{verticalAlign: 'middle'}}/>
...
2. Enable custom formatters in your browser:
   ...
   * In Chrome DevTools, it's available via **Settings | Preferences | Console**:
     ...
     <img src="/img/wasm-custom-formatters-chrome.png" alt="Enable custom formatters in Chrome" width="700" style={{verticalAlign: 'middle'}}/>

   * In Firefox DevTools, it's available via **Settings | Advanced settings**:

     <img src="/img/wasm-custom-formatters-firefox.png" alt="Enable custom formatters in Firefox" width="700" style={{verticalAlign: 'middle'}}/>
