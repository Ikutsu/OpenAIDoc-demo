...
<img src="/img/warning-name-intention.png" width="500" alt="Warning name intent  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/compiler-options-levels.svg" width="700" alt="Kotlin compiler options lev  style={{verticalAlign: 'middle'}}/>
...
4. Adjust the script to feature the `embedSwiftExportForXcode` task instead in the run script phase:
   ...
   <img src="/img/xcode-swift-export-run-script-phase.png" width="700" alt="Add the Swift export scr  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/wasm-old-debugger.png" width="700" alt="Kotlin/Wasm old debug  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/wasm-debugger-improved.png" width="700" alt="Kotlin/Wasm improved debug  style={{verticalAlign: 'middle'}}/>
...
2. Enable custom formatters in your browser:
   ...
   * In Chrome DevTools, it's available via **Settings | Preferences | Console**:
     ...
     <img src="/img/wasm-custom-formatters-chrome.png" width="700" alt="Enable custom formatters in Chr  style={{verticalAlign: 'middle'}}/>

   * In Firefox DevTools, it's available via **Settings | Advanced settings**:

     <img src="/img/wasm-custom-formatters-firefox.png" width="700" alt="Enable custom formatters in Fire  style={{verticalAlign: 'middle'}}/>
