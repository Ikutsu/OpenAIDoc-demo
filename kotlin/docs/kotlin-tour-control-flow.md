...
:::info
    ...
    <p>
   <img src="icon-1-done.svg" width="20" alt="First step"   'middle'}}/> <a href="kotlin-tour-hello-world.md">Hello world</a><br />
        <img src="icon-2-done.svg" width="20" alt="Second step"   'middle'}}/> <a href="kotlin-tour-basic-types.md">Basic types</a><br />
        <img src="icon-3-done.svg" width="20" alt="Third step"   'middle'}}/> <a href="kotlin-tour-collections.md">Collections</a><br />
        <img src="icon-4.svg" width="20" alt="Fourth step"   'middle'}}/> <strong>Control flow</strong><br />
...
<ul>
  <li>
    <h3>Hint</h3>
    <div>Use the <a href="operator-overloading.md#equality-and-inequality-operators">equality operator</a> (<code>==</code>) to compare the dice results.</div>
  </li>
</ul>
...
<ul>
  <li>
    <h3>Hint 1</h3>
    <div>Use a <code>for</code> loop to count numbers and a <code>when</code> expression to decide what to print at each
        step.</div>
  </li>
</ul>
...
<ul>
  <li>
    <h3>Hint 2</h3>
    <div>Use the modulo operator (<code>%</code>) to return the remainder of a number being divided. Use the <a href="operator-overloading.md#equality-and-inequality-operators">equality operator</a> 
        (<code>==</code>) to check if the remainder equals zero.</div>
  </li>
</ul>
...
<ul>
  <li>
    <h3>Hint</h3>
    <div>Use the <a href="https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.text/starts-with.html"> <code>.startsWith()</code>
        </a> function for <code>String</code> type.</div>
  </li>
</ul>
