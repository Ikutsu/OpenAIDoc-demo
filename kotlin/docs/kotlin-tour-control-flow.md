...
<p>
   <img src="/img/icon-1-done.svg" width="20" alt="First step" /> <a href="kotlin-tour-hello-world.md">Hello world</a><br />
        ...
        <img src="/img/icon-4.svg" width="20" alt="Fourth step" /> <strong>Control flow</strong><br />
...
:::
<h3>Hint</h3>
        Use the <a href="operator-overloading.md#equality-and-inequality-operators">equality operator</a> (`==`) to compare the dice results. 
...
<h3>Hint 1</h3>
        Use a `for` loop to count numbers and a `when` expression to decide what to print at each
        step. 
<h3>Hint 2</h3>
        Use the modulo operator (`%`) to return the remainder of a number being divided. Use the <a href="operator-overloading.md#equality-and-inequality-operators">equality operator</a> 
...
<h3>Hint</h3>
        Use the <a href="https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.text/starts-with.html"> `.startsWith()`
        </a> function for `String` type. 
