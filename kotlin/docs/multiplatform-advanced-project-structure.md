...
<img src="/img/dependson-tree-diagram.svg" width="700" alt="DependsOn tree struct  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/dependson-relations-diagram.svg" width="700" alt="DependsOn relations during compilat  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/missing-dependson-diagram.svg" width="700" alt="Missing dependsOn relat  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/final-structure-diagram.svg" width="700" alt="Final project struct  style={{verticalAlign: 'middle'}}/>
...
1. Multiplatform dependencies are propagated down the `dependsOn` structure. When you add a dependency to `commonMain`,
   ...
   <img src="/img/dependency-propagation-diagram.svg" width="700" alt="Propagation of multiplatform dependenc  style={{verticalAlign: 'middle'}}/>
...
:::
   ...
   <img src="/img/structure-serialization-diagram.svg" width="700" alt="Serialization of the source set struct  style={{verticalAlign: 'middle'}}/>
...
3. Kotlin takes each dependency relation and resolves it to a collection of source sets from a dependency.
   ...
   <img src="/img/dependency-resolution-error.png" width="700" alt="Error on JVM-specific API in common c  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/multiplatform-source-set-dependency-alignment.svg" width="700" alt="Alignment of dependencies among *Main source se  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/test-main-source-set-dependency-alignment.svg" alt="Test source sets resolving dependencies separately from the main source se  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/ios-compilation-diagram.svg" width="700" alt="Kotlin compilation for   style={{verticalAlign: 'middle'}}/>
