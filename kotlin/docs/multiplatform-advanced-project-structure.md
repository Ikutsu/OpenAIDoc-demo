...
<img src="/img/dependson-tree-diagram.svg" width="700" alt="DependsOn tree structure"  'middle'}}/>
...
<img src="/img/dependson-relations-diagram.svg" width="700" alt="DependsOn relations during compilation"  'middle'}}/>
...
<img src="/img/missing-dependson-diagram.svg" width="700" alt="Missing dependsOn relation"  'middle'}}/>
...
<img src="/img/final-structure-diagram.svg" width="700" alt="Final project structure"  'middle'}}/>
...
1. Multiplatform dependencies are propagated down the `dependsOn` structure. When you add a dependency to `commonMain`,
   ...
   <img src="/img/dependency-propagation-diagram.svg" width="700" alt="Propagation of multiplatform dependencies"  'middle'}}/>
...
:::
   ...
   <img src="/img/structure-serialization-diagram.svg" width="700" alt="Serialization of the source set structure"  'middle'}}/>
...
3. Kotlin takes each dependency relation and resolves it to a collection of source sets from a dependency.
   ...
   <img src="/img/dependency-resolution-error.png" width="700" alt="Error on JVM-specific API in common code"  'middle'}}/>
...
<img src="/img/multiplatform-source-set-dependency-alignment.svg" width="700" alt="Alignment of dependencies among *Main source sets"  'middle'}}/>
...
<img src="/img/test-main-source-set-dependency-alignment.svg" alt="Test source sets resolving dependencies separately from the main source sets"  'middle'}}/>
...
<img src="/img/ios-compilation-diagram.svg" width="700" alt="Kotlin compilation for iOS"  'middle'}}/>
