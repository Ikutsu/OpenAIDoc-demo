...
:::info
    ...
    <p>
   <img src="icon-1.svg" width="20" alt="First step"  style={{verticalAlign: 'middle'}}/> <strong>Hello world</strong><br />
        <img src="icon-2-todo.svg" width="20" alt="Second step"  style={{verticalAlign: 'middle'}}/> <a href="kotlin-tour-basic-types.md">Basic types</a><br />
