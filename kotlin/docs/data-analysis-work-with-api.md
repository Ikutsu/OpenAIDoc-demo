...
<img src="/img/results-of-expanding-group-data-analysis.png" width="700" alt="Expanding a row to reveal more details"  'middle'}}/>

You can click the table icon in the bottom left to return to the grouped dataset.

<img src="/img/return-to-grouped-dataset.png" width="700" alt="Click on the table icon in the bottom left to return"  'middle'}}/>
...
<img src="/img/kotlin-analysis.png" width="700" alt="Analysis results"  'middle'}}/>
