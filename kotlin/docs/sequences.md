...
<img src="/img/list-processing.svg" alt="List process  style={{verticalAlign: 'middle'}}/>
...
<img src="/img/sequence-processing.svg" alt="Sequences process  style={{verticalAlign: 'middle'}}/> {width="700"}
