...
This project uses **Gradle**, **Kotlin**, **Spring Web**, **Spring Data JDBC**, and **H2 Database**:
   ...
   <img src="/img/spring-boot-create-project-with-initializr.png" width="800" alt="Create a new project with Spring Initial  style={{verticalAlign: 'middle'}}/>
...
3. Unpack the **.zip** file and open it in IntelliJ IDEA.
   ...
   <img src="/img/spring-boot-project-structure.png" width="350" alt="The Spring Boot project struct  style={{verticalAlign: 'middle'}}/>
...
the launch menu in IntelliJ IDEA:
   ...
   <img src="/img/spring-boot-run-the-application.png" width="800" alt="Run the applicat  style={{verticalAlign: 'middle'}}/>
...
2. Once the application starts, open the following URL: [http://localhost:8080](http://localhost:8080).
   ...
   <img src="/img/spring-boot-output.png" alt="Application out  style={{verticalAlign: 'middle'}}/>
...
the database scheme:
   ...
   <img src="/img/spring-boot-sql-scheme.png" width="300" alt="Create a new fol  style={{verticalAlign: 'middle'}}/>
...
3. Execute all POST requests. Use the green **Run** icon in the gutter next to the request declaration.
   ...
   <img src="/img/spring-boot-run-http-request.png" alt="Run HTTP POST reques  style={{verticalAlign: 'middle'}}/>

4. Execute the GET request and see the result in the **Run** tool window:

   <img src="/img/spring-boot-output-2.png" alt="Run HTTP GET requ  style={{verticalAlign: 'middle'}}/>
...
<a href="https://info.jetbrains.com/kotlin-tips.html">
   <img src="get-kotlin-language-map.png" width="700" alt="Get the Kotlin language map"  'middle'}}/>
</a>
