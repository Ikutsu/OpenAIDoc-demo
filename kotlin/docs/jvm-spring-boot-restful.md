...
This project uses **Gradle**, **Kotlin**, **Spring Web**, **Spring Data JDBC**, and **H2 Database**:
   ...
   <img src="/img/spring-boot-create-project-with-initializr.png" width="800" alt="Create a new project with Spring Initializr" style={{verticalAlign: 'middle'}}/>
...
3. Unpack the **.zip** file and open it in IntelliJ IDEA.
   ...
   <img src="/img/spring-boot-project-structure.png" width="350" alt="The Spring Boot project structure" style={{verticalAlign: 'middle'}}/>
...
the launch menu in IntelliJ IDEA:
   ...
   <img src="/img/spring-boot-run-the-application.png" width="800" alt="Run the application" style={{verticalAlign: 'middle'}}/>
...
the database scheme:
   ...
   <img src="/img/spring-boot-sql-scheme.png" width="300" alt="Create a new folder" style={{verticalAlign: 'middle'}}/>
...
<a href="https://info.jetbrains.com/kotlin-tips.html">
   <img src="/img/get-kotlin-language-map.png" width="700" alt="Get the Kotlin language map" style={{verticalAlign: 'middle'}}/>
</a>
