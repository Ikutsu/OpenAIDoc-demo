...
:::info
    ...
    <p>
   This is the final part of the <strong>Mapping Kotlin and C</strong> tutorial series. Before proceeding, make sure you've completed the previous steps.
   </p>
    <p>
   <img src="/img/icon-1-done.svg" width="20" alt="First step" style={{verticalAlign: 'middle'}}/> <a href="mapping-primitive-data-types-from-c.md">Mapping primitive data types from C</a><br/>
        <img src="/img/icon-2-done.svg" width="20" alt="Second step" style={{verticalAlign: 'middle'}}/> <a href="mapping-struct-union-types-from-c.md">Mapping struct and union types from C</a><br/>
      <img src="/img/icon-3-done.svg" width="20" alt="Third step" style={{verticalAlign: 'middle'}}/> <a href="mapping-function-pointers-from-c.md">Mapping function pointers</a><br/>
      <img src="/img/icon-4.svg" width="20" alt="Fourth step" style={{verticalAlign: 'middle'}}/> <strong>Mapping strings from C</strong><br/>
   </p>
