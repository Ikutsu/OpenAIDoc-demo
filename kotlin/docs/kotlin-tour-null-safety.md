...
:::info
   ...
   <img src="/img/icon-1-done.svg" width="20" alt="First step"  style={{verticalAlign: 'middle'}}/> <a href="kotlin-tour-hello-world.md">Hello world</a><br />
        ...
        <img src="/img/icon-6-done.svg" width="20" alt="Sixth step"  style={{verticalAlign: 'middle'}}/> <a href="kotlin-tour-classes.md">Classes</a><br />
        <img src="/img/icon-7.svg" width="20" alt="Final step"  style={{verticalAlign: 'middle'}}/> <strong>Null safety</strong><br />
   </p>
