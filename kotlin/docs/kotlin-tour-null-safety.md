...
:::info
   ...
   <img src="icon-1-done.svg" width="20" alt="First step"   'middle'}}/> <a href="kotlin-tour-hello-world.md">Hello world</a><br />
        ...
        <img src="icon-6-done.svg" width="20" alt="Sixth step"   'middle'}}/> <a href="kotlin-tour-classes.md">Classes</a><br />
        <img src="icon-7.svg" width="20" alt="Final step"   'middle'}}/> <strong>Null safety</strong><br />
   </p>
