...
<img src="/img/multiplatform-hierarchy-completion.animated.gif" alt="IDE completion for source set names" width="350" preview-src="/img/multiplatform-hierarchy-completion.png" style={{verticalAlign: 'middle'}}/>
