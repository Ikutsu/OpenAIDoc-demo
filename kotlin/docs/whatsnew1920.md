...
<img src="/img/default-hierarchy-example.svg" alt="An example of the default target hierarchy in   style={{verticalAlign: 'middle'}}/>{thumbnail="true" width="350" thumbnail-same-file="true"}
...
<img src="multiplatform-hierarchy-completion.animated.gif" alt="IDE completion for source set names" width="350" preview-src="multiplatform-hierarchy-completion.png"  'middle'}}/>
...
<img src="/img/full-template-hierarchy.svg" alt="Default hierarchy templa  style={{verticalAlign: 'middle'}}/>
